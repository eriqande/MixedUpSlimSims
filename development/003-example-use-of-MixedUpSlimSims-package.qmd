...
Here, before we run it, we will remove all the files produced by this test run.
```{sh}
rm "p1-10.vcf" "p1-11.vcf" "p1-9.vcf"  "p2-10.vcf" "p2-11.vcf" "p2-9.vcf"
```
...
In practice, most of the time you will be reading in multiple VCF files.  For that we 
...
in a list named by the population.  For example, to get the years 9, 10, and 11 from
